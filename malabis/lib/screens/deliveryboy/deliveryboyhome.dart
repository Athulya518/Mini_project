          ...
          child: Column(
            ...
            children: [
              Center(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>CompletedWork()));
                  },
                  child: Container(
                    margin: EdgeInsets.only(left: 40,right: 40),

                    height: 75,
                    child: Center(child: Text("Completed  Work",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w400,fontSize: 18),)),
              ...
              Center(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>PickMaterial()));
                  },
                  child: Container(
                    margin: EdgeInsets.only(left: 40,right: 40),
