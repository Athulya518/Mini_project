              ...
              slivers: [
                                ...
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: index%2==0?Colors.blueGrey.withOpacity(0.6):Colors.green,
                                        borderRadius:
                ...
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            .collection('shop').where('type',isEqualTo: "Men")
                            .where('status', isEqualTo: 1)
                            .snapshots(),
                        builder: (context, snapshot) {
                          if (snapshot.hasData &&
                ...
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            .collection('shop').where('type',isEqualTo: "Women")
                            .where('status', isEqualTo: 1)
                            .snapshots(),
                        builder: (context, snapshot) {
                          if (snapshot.hasData &&
                ...
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            .collection('shop').where('type',isEqualTo: "Boys")
                            .where('status', isEqualTo: 1)
                            .snapshots(),
                        builder: (context, snapshot) {
                          if (snapshot.hasData &&
                ...
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            .collection('shop').where('type',isEqualTo: "Girls")
                            .where('status', isEqualTo: 1)
                            .snapshots(),
                        builder: (context, snapshot) {
                          if (snapshot.hasData &&
