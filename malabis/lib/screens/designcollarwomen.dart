...
var shoptype;
   ...
   CollarstyleWomen({Key? key,this.designimageurl,this.neckdesign,this.category,this.type,this.wristdesign,this.uid,this.name,this.phone,this.stitching_price,this.shoptype,this.shopid}) : super(key: key);
