...
var shopid;
var shoptype;
  SuccessPage({Key? key,this.designimageurl,this.pickup_date,this.oid,this.newaddress,
    this.designcollar,this.wristdesign,this.neckdesign,this.category,
    this.shoptype,this.shopid,
    this.type,this.orderdeliver_pincode,this.orderdeliverlocation,this.orderdeliveraddress,
    this.cashbyhand_material_date,this.materialpickup_pincode,this.materialpickup_location,this.materialpickup_address,this.samplegarment_pickuppincode,this.samplegarment_pickuplocation,this.samplegarment_pickupaddress,this.submit_measurement,this.material_price,this.fabrictype,this.stitching_price,this.newlocation,this.newpincode,this.preferred_order_date,this.uid,this.name,this.phone}) : super(key: key);
...
'phone': widget.phone,
'type': widget.type,
'category': widget.category,'designimageurl':widget.designimageurl,
...
name: widget.name,phone: widget.phone,uid:widget.uid,shoptype: widget.shoptype,
  shopid: widget.shopid,
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: Color(0xffef9f9f),
              ),
